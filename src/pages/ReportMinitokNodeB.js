...
export default function ReportMinitokNodeB() {
  ...
  const handleFileSelected = async (e) => {
    ...
    try {
      ...
      const res = await Swal.fire({ title: "Konfirmasi import", text: `Import ${items.length} item?`, icon: "question", showCancelButton: true, confirmButtonText: "Ya, import", cancelButtonText: "Batal" });
      if (!res.isConfirmed) return;
